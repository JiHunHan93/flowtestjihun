package com.jihunh.spring.section01.model.dto;
...
public class MgDTO {
	...
	public MgDTO(int no, String name, String id, String pwd, String pno, String gender, String email, String address,
			String phone, String subPhone, int point, Date enrollDate, Date modifiedDate, String blackList, String status) {
		super();
		this.no = no;
		this.name = name;
		this.id = id;
	...
	public String toString() {
		return "MgDTO [no=" + no + ", name=" + name + ", id=" + id + ", pwd=" + pwd + ", pno=" + pno + ", gender=" + gender
				+ ", email=" + email + ", address=" + address + ", phone=" + phone + ", subPhone=" + subPhone + ", point="
				+ point + ", enrollDate=" + enrollDate + ", modifiedDate=" + modifiedDate + ", blackList=" + blackList
				+ ", status=" + status + "]";
	}
